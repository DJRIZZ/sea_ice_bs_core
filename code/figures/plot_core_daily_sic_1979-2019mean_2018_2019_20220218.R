# code to make the figure "ce_cover_pct_core_mean_2018_2020.png;
# which plots daily 1979-2020 mean pct ice cover across the 4 "core" area pixels
# daily mean ice cover in 4 core area pixels in winter years: 2018, 2019

# to do this, this code calculates the long term mean 1979-2019
...
# subset data that includes data from 16 pixels to 4 core pixels Petersen and Douglas call the "core" area, numbers 1 to 4
core.ice<-subset(all.ice, pixel < 5)

# convert ice coverage from permil to percent, divide values by 10
...
#plot(as.factor(mean.ice$short.date), mean.ice$pct)
