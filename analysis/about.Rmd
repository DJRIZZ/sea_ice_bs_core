...
Note: *.nc and *.tif files are NOT included in this repository, to save space. Files can be downloaded from the NSIDC using the downloading code in code/sic_nsidc_download_summarize/00_download_seaice_data_from_nsidc_[version date].R
